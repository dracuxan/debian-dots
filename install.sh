...
for dir in fastfetch nvim alacritty i3 i3status picom kitty rofi starship dunst eww; do
    mkdir -p "$HOME/.config/$dir"
done

echo "[+] Stowing configs into ~/.config/..."

for dir in fastfetch nvim alacritty i3 i3status picom kitty rofi dunst eww; do
